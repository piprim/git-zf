...
func TestRunBranchPrune(t *testing.T) {
	t.Parallel()

	t.Run("dry-run reports branch missing from local refs", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("dry-run reports branch merged into base", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("dry-run prints 'Nothing to prune' when all branches are still active", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("dry-run reports deleted and merged branches but omits active ones", func(t *testing.T) {
		t.Parallel()
