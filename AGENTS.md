...
This project is indexed by GitNexus as **workspace** (2591 symbols, 8403 relationships, 220 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
