...
This project is indexed by GitNexus as **workspace** (2667 symbols, 8760 relationships, 226 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
